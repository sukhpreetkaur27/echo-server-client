package com.grizzly.sample.client;
...
import com.grizzly.sample.filter.ClientFilter;

public class EchoClient {

  public static final Logger logger = Grizzly.logger(EchoClient.class);
  ...
  public static void main(String[] args)
    ...
    // ClientFilter is responsible for redirecting server responses to the standard
    // output
